...
%        
%        if (count==1 && i==1)
%            trial=load('ResultPshortmodel2aLS0504a.mat');
%            trial=cell2mat(struct2cell(trial)); %zeros(1,D);
%        end
%        trial(6)=0; trial(13)=0; %K_m^*=K_n^*=0;
       score=model2aErrorFls(tspan,IC,trial); %go to use fitness funtion to evaluate the error
...
save('ResultPshortmodel2a0705.mat','trial0');
