...
trial=load('ResultPshortmodel1aLS0502c.mat');
...
t1=[0 2500];
[t1,x]=ode45(@model1aDE,t1,IC,[],p);
t60=find(abs(t1-60)<0.6,1,'first');
...
% trial(11)=p.c2;
% trial(12)=p.d2;
% score=model1aErrorF(t1,IC,trial);
...
figure;
hold all
plot(t1(t60:end),x(t60:end,4),'red');
...
% plot(43200,0.864036089,'red+');./x(t60,4)
hold off
