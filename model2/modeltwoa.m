...
tspan=[0,t1,t2,t3,t4,t5,t6,t7]; %build time range
...
for count=1:1:maxgen  
   for i=1:1:NP
       ...
       %disp(trial);
       score=modeltwo1(tspan,IC,trial); %go to use fitness funtion to evaluate the error
...
save('ResultFittingmodel2a.mat','trial');
