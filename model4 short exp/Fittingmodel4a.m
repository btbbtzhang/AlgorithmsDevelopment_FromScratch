...
F = 0.8;        %difference posibility
CR = .2;        %cross posibility
D  = 10;        %dimension 
...
for count=1:1:maxgen  
   for i=1:1:NP
       ...
       %disp(trial);
       score=model4aErrorF(tspan,IC,trial); %go to use fitness funtion to evaluate the error
...
save('ResultPshortmodel4a0404.mat','trial0');
